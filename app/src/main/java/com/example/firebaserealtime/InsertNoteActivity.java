...
public class InsertNoteActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase = FirebaseDatabase.getInstance("https://pamfirebase-6af58-default-rtdb.asia-southeast1.firebasedatabase.app/");
    ...
    public void submitData(){
        ...
        databaseReference.child("notes").child(mAuth.getUid()).setValue(baru).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
